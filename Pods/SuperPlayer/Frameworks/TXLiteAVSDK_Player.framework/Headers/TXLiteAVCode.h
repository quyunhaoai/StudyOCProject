...
typedef enum TXLiteAVError
{
    ...
    ERR_PLAY_LIVE_STREAM_NET_DISCONNECT             = -2301,    ///< 直播、点播，网络断连，且经多次重连抢救无效，可以放弃治疗，更多重试请自行重启播放
    ...
    ERR_VOD_LOAD_LICENSE_FAIL                       = -2310,    ///< 点播，加密失败获取License失败
    ERR_VOD_UNSUPPORT_DRM                           = -2311,    ///< 点播，Android使用的错误码，此设备不支持DRM播放
