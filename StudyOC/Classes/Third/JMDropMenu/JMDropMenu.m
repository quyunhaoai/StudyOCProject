...
//Base style for 路径 615
//UIView *style = [[UIView alloc] initWithFrame:CGRectMake(121, 37, 62, 41)];
//style.layer.backgroundColor = [[UIColor colorWithRed:66.0f/255.0f green:65.0f/255.0f blue:83.0f/255.0f alpha:1.0f] CGColor];
//style.alpha = 1;
