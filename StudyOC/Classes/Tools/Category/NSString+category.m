...
//
//    NSString *target = [[NSUserDefaults standardUserDefaults] objectForKey:@"fromTarget"];
//    BOOL aa = [self inputShouldNumber:target];
//    if (aa == YES) {
//        return target;
//    } else {
//        NSString *fromTarget = @"-1000";
//        for (NSDictionary *dic in [ManagerModel openArrayModelOfPlistFileName:@"maidian.plist"]) {
//            if ([[dic allKeys] containsObject:target]) {
//                fromTarget = [dic allValues][0];
//            }
//        }
//        return fromTarget;
//    }
...
//    
//    NSString *dataJSonStr = [self dictionaryToJson:dataDic];
//    NSString *dateStr = [self getCurrentIntervalTime];
//    NSString *deviceSignStr = [[NSUserDefaults standardUserDefaults] objectForKey:DeviceSign];
//    if (!deviceSignStr) {
//        
//        deviceSignStr = [self getDeviceUUID];
//        [[NSUserDefaults standardUserDefaults] setObject:deviceSignStr forKey:DeviceSign];
...
//             @"v":VERSION,
//             @"data":dataJSonStr,
//             @"device":deviceSignStr,
//             @"sign":[self getSignValue:dataJSonStr dateStr:dateStr]};
//}

/**
 *  xigua
 *  XYKey  "*Yn*M)h3'IF^h%N)U|ZP"
 *  @param  dataJSonStr 请求json串
 *
 *  @return 请求签名
 */
//+(NSString *)getSignValue:(NSString *)dataJSonStr
//                  dateStr:(NSString *)dateStr
//{
//    NSString *tempStr = [NSString stringWithFormat:@"%@timestamp%@platiosv%@data%@%@",XYKey,
//                         dateStr,
//                         VERSION,
//                         dataJSonStr,
//                         XYKey];
//    return [self md5:tempStr];
//    
//}
