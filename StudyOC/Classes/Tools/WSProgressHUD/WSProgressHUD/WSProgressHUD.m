...
#import "MMMaterialDesignSpinnerViews.h"
...
@property (nonatomic, strong) MMMaterialDesignSpinnerViews *spinnerView;
...
- (void)dismiss
{
    ...
    objc_setAssociatedObject(self, @selector(maskType), @(0), OBJC_ASSOCIATION_ASSIGN);
...
//                    }
                ...
                self.spinnerView.center = self.indefiniteAnimationView.center = self.indicatorView.center = CGPointMake(25, hudCenterY);
...
#pragma clang diagnostic pop
    ...
    return CGSizeMake(WSProgressHUDDefaultWidth+40, WSProgressHUDDefaultHeight+20);
}
...
- (void)updateSubview
{
    ...
    self.hudView.backgroundColor = [UIColor colorWithWhite:0 alpha:0.5];
...
- (MMMaterialDesignSpinnerViews *)spinnerView
{
    if (!_spinnerView) {
        _spinnerView = [[MMMaterialDesignSpinnerViews alloc] initWithFrame:CGRectZero];
