//
//  MMMaterialDesignSpinnerViews.m
//  Pods
//
...
static NSString *kMMRingStrokeAnimationKey = @"MMMaterialDesignSpinnerViews.stroke";
static NSString *kMMRingRotationAnimationKey = @"MMMaterialDesignSpinnerViews.rotation";

@interface MMMaterialDesignSpinnerViews ()
@property (nonatomic, readonly) CAShapeLayer *progressLayer;
@property (nonatomic, readwrite) BOOL isAnimating;
@end

@implementation MMMaterialDesignSpinnerViews
