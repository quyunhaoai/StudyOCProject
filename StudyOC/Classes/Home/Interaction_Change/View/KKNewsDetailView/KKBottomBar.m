...
- (KKTextView *)textView{
    if(!_textView){
        _textView = ({
            ...
            view.backgroundColor = [UIColor colorWithRed:2.0/255.0 green:1.0/255.0 blue:2.0/255.0 alpha:1.0];
            view.placeholderColor = [UIColor colorWithRed:53.0/255.0 green:52.0/255.0 blue:53.0/255.0 alpha:1.0];
