...
- (void)layoutUI{
    ...
    // 创建表格
    if (!_commentListView) {
        _commentListView = [[ZMCusCommentListView alloc] initWithFrame:CGRectMake(0, SCREEN_HEIGHT, Window_W, 0)];
        @STweakify(self)
...
- (ZMCusCommentToolView *)toolView{
    ...
    if (!_toolView) {
        self.historyFrame = CGRectMake(0, 0, Window_W, 47);
        _toolView = [[ZMCusCommentToolView alloc] initWithFrame:CGRectMake(0, 0, Window_W, 47)];
...
- (void)hideView{
    ...
    [UIView animateWithDuration:0.2 animations:^{
        self.commentListView.frame = CGRectMake(0, SCREEN_HEIGHT, Window_W, 0);
...
- (void)showView{
    [UIView animateWithDuration:0.2 animations:^{
        self.commentListView.frame = CGRectMake(0, ZMCusCommentViewTopHeight, Window_W, SCREEN_HEIGHT);
    } completion:^(BOOL finished) {
...
- (void)showCommentWithSourceId:(NSString *)sourceId{
    ...
    ZMCusCommentView *view = [[ZMCusCommentView alloc] initWithFrame:CGRectMake(0, 0, Window_W, SCREEN_HEIGHT)];
    // 发送通知数据
