...
- (void)configData:(id)data{
    ...
    CGFloat contentHeight =[self.contentLab.text heightWithFont:[UIFont systemFontOfSize:13] constrainedToWidth:Window_W-28-7-18-12];
