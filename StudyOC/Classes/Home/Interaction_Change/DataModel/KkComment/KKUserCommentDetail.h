...
/**
 回复信息
 */
@interface KKCommentReplyData:STBaseModel
...
@interface KKCommentReply : STBaseModel
...
/**
 点赞信息
 */
@interface KKCommentDiggData : STBaseModel
...
@interface KKCommentDigg : STBaseModel
@property(nonatomic,copy)NSString *message;
...
/**
 用户个人评论详情
 */
@interface KKUserCommentDetailObj : STBaseModel
...
@interface KKUserCommentDetail : STBaseModel
@property(nonatomic,copy)NSString *ban_face;
@property(nonatomic,copy)NSString *message;
