...
//    } else {
        //评论
        _height = ( 17 + 14 + 7 + 12.5 + 14 + 17 + [self.content boundingRectWithSize:CGSizeMake(Window_W - 14 -14 -14 -34, CGFLOAT_MAX) options:NSStringDrawingUsesLineFragmentOrigin attributes:@{ NSFontAttributeName:[UIFont systemFontOfSize:14]} context:nil].size.height -25);
//    }
    }
    return _height;
}
//+ (NSDictionary *)modelCustomPropertyMapper {
//    return @{@"replayArray"  : @"recent_replay",
//    };
//}
@end
