...
//    if([MD5_UDID isEqualToString:_chat.visitor.udid]){
        ...
        _backgroundlayer.fillColor = kYellowColor.CGColor;
//
//    }else {
...
//        _textView.frame = CGRectMake(CGRectGetMaxX(self.avatar.frame) + kTextMsgPadding, kTextMsgPadding, size.width + kTextMsgCornerRadius * 2, size.height + kTextMsgCornerRadius * 2);
        _backgroundlayer.fillColor = kWhiteColor.CGColor;
//    }
...
//    [_avatar setImageWithURL:[NSURL URLWithString:@""] progressBlock:^(CGFloat persent) {
...
+ (NSDictionary* ) attributes {
    return @{NSFontAttributeName:FONT_12,NSForegroundColorAttributeName:kBlackColor};
}
