...
@interface STGroupChatViewController ()<JXCategoryListContentViewDelegate>
@property (strong, nonatomic) STFollowTipView *tipView; //  视图

@end

@implementation STGroupChatViewController
...
- (void)viewDidLoad {
    ...
    [button setTitle:@"建群聊两句" forState:UIControlStateNormal];
