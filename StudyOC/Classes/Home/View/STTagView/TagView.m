...
- (void)setDataSources:(NSArray *)dataSources {
    ...
    for (int i=0; i<dataSources.count; i++) {
        ...
        tipBtn.titleLabel.font=FONT_14;
        [tipBtn setBackgroundColor:KKRandomColor];
        [tipBtn setTitleColor:[UIColor colorWithRed:153/255.0
                                              green:153/255.0
                                               blue:153/255.0
                                              alpha:1]
                                           forState:UIControlStateNormal];
        [tipBtn setTitleColor:[UIColor colorWithRed:255/255.0
                                              green:255/255.0
                                               blue:255/255.0
                                              alpha:0.7]
        ...
        if ((self.width - CGRectGetMaxX(_lastFrame)) >= size.width + 25) {
        ...
        if (_lastFrame.origin.y < Window_W*0.56-50) {
