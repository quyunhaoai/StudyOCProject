...
@interface STSocialBaseViewController ()<JXCategoryListContainerViewDelegate,JXCategoryViewDelegate>

@end

@implementation STSocialBaseViewController
